...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Edit Profil Anda</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="w-24 h-24 rounded-full bg-gray-200 overflow-hidden border-2 border-gray-300">
                        ...
                        <div class="w-full">
                            <div class="file-input-wrapper w-full">
                                <button type="button" class="w-full bg-primary hover:bg-primary-dark text-white py-2 px-4 rounded-lg transition flex items-center justify-center gap-2">
                            ...
                            <p id="file-name" class="mt-2 text-sm text-gray-500 text-center">Belum ada file dipilih</p>
                            <p class="mt-1 text-sm text-gray-500 text-center">Format: JPG, PNG, GIF (Max: 2MB)</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('cms.home') }}" class="text-primary font-medium hover:underline">&larr; Kembali ke dashboard</a>
            </div>
        </div>
    </div>
</body>
